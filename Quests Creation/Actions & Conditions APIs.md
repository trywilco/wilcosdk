...
| [quest_notification](Actions%20&%20Conditions%20APIs/quest_notification.md)                                        | Quest    | Action    | Notify a user about an event that happened while playing in a quest. |
